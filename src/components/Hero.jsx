...
import SecurityFrame from '../../App/Red frame.png';
import PurpleGradient from '../../App/Purple gradient.png';
import GreenGradient from '../../App/Green gradient.png';
    ...
    <div className="hero-container">
      ...
      <div className="feature-cards">
        <div className="feature-card-security">
          <img src={SecurityFrame} alt="Security Frame" className="feature-image" />
        ...
        <div className="feature-card-regulations">
          <img src={PurpleGradient} alt="Purple Gradient" className="feature-image" />
          <div className="feature-content">
            <h3>Regulations</h3>
        ...
        <div className="feature-card-leverage">
          <img src={GreenGradient} alt="Green Gradient" className="feature-image" />
          <div className="feature-content">
